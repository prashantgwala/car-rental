...
import { assets, dummyDashboardData, dummyMyBookingsData } from '../../assets/assets'
...
//       <Title title="Admin Dashboard" subTitle="Monitor overall platfrom performance
//       including totla cars, revenue, and recent activities"/>
...
//           <div>
//            <h1 className='taxt-xs text-gray-500'>{card.title}</h1>
...
//           <p className='text-3xl mt-6 font-semibold text-primary'>{currency}{data.monthyRevenue}</p>
//         </div>
//       </div>
//     </div>
//   )
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 flex-1">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8">
        {dashboardCards.map((card, idx) => (
          <div key={idx} className="bg-white rounded-lg shadow border border-gray-200 p-4 flex items-center justify-between">
            <div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200 p-6 flex flex-col justify-center">
          <h1 className="text-lg font-medium">Monthly Revenue</h1>
          <p className="text-gray-500">Revenue for current month</p>
