...
const ManageBookings = () => {
  ...
  return (
    ...
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <Title title='Manage Bookings' subTitle="view all listed cars, update their details
          ...
          <tbody>
            {bookings.map((booking, index) => (
              ...
              aspect-square rounded-md object-cover'/>
                ...
                <td className='p-3 max-md:hidden'>
                  <span className='bg-gray-100 px-3 py-1 rounded-full text-x5'>offline</span>
                </td>
                    ...
                    <span
                      className={
                        booking.status === 'confirmed'
                          ? 'px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-500'
                          : 'px-3 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-500'
                      }
                    >
                      {booking.status}
                    </span>
