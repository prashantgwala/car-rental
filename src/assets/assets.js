...
export const ownerMenuLinks = [
    ...
    { name: "Add car", path: "add-cars", icon: addIcon, coloredIcon: addIconColored },
    { name: "Manage Cars", path: "manage-cars", icon: carIcon, coloredIcon: carIconColored },
    { name: "Manage Bookings", path: "manage-bookings", icon: listIcon, coloredIcon: listIconColored },
]
