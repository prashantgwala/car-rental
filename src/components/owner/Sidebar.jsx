  ...
  return (
    ...
    max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      <div className='group relative'>
        <label htmlFor='image'>
          <img src={image ? URL.createObjectURL(image) : user?.image ||
            "http:///C:/Users/DELL/Downloads/549521740_17901490389261182_3614208351310171724_n.jpg w=300"}
            alt="" className='h-9 md:h-14 w-9 md:w-14 rounded-full max-auto'/>
      ...
      {image && (
        ...
        text-primary curdor-pointer'>Save <img src={assets.check_icon} width={13} alt=''
