...
const Banner = () => {
  return (
    ...
    max-w-6xl mx-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      ...
      <div className='text-white'>
        ...
        <p className='max-w-130'>We take car of insurance, driver verification and secure payments- so you can
